...
def loadData():
    ...
    the LES mesh. This is described in my PhD thesis.
    """
    ...
    x_r1, tb_r1, uc_r1, gradc_r1, nut_r1 = joblib.load("data_jicfr1_10k.pckl")    
    x_r1p5, tb_r1p5, uc_r1p5, gradc_r1p5, nut_r1p5 = joblib.load("data_jicfr1p5_10k.pckl")        
    x_r2, tb_r2, uc_r2, gradc_r2, nut_r2 = joblib.load("data_jicfr2_10k.pckl")
    print("Done!")
